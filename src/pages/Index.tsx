...
import { posts as initialPosts, fetchAdditionalPosts } from "@/data/posts";
...
const Index = () => {
  ...
  const [posts, setPosts] = useState(initialPosts); // Start with initial posts
  const [loading, setLoading] = useState(false);

  // Fetch additional posts and append to the existing ones
  ...
  // Trigger loadPosts on initial load to append additional posts if needed
  useEffect(() => {
    loadPosts(); // Load more posts initially if needed
  }, []);
